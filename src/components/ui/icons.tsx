...
const PATHS = {
  ...
  mic: 'M12 15a3.5 3.5 0 0 0 3.5-3.5v-5a3.5 3.5 0 1 0-7 0v5A3.5 3.5 0 0 0 12 15Zm6-3.5a6 6 0 0 1-12 0M12 17.5V21m-3.5 0h7',
  phoneDown: 'M3 14c0-2 4-4.5 9-4.5s9 2.5 9 4.5c0 1.2-.6 2.3-1.6 2.5l-3-.6c-.8-.2-1.4-.9-1.4-1.7v-1.3a9.6 9.6 0 0 0-6 0v1.3c0 .8-.6 1.5-1.4 1.7l-3 .6C3.6 16.3 3 15.2 3 14Z',
} as const;
